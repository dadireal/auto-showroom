...
export default function WhyChooseUs({ totalVehicles = 24 }) {
  ...
  return (
    <section id="why-us" style={{ padding: '96px 0', background: '#090D16', color: '#fff', borderTop: '1px solid rgba(255, 255, 255, 0.06)' }}>
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '750px', margin: '0 auto 56px' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', color: '#fff', marginBottom: '14px', fontWeight: 900, letterSpacing: '-0.02em' }}>
            {t('whyUs.title')} <span style={{ color: '#FF6B00' }}>{t('whyUs.titleAccent')}</span> ?
          </h2>
        ...
        <div className="why-us-pillars-grid" style={{ marginBottom: '56px' }}>
          {reasons.map((r, i) => (
            ...
            >
              ...
              <h3 style={{ fontSize: '1.18rem', fontWeight: 800, marginBottom: '10px', color: '#fff' }}>
                {r.title}
              </h3>
