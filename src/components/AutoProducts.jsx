    ...
    <section id="products" style={{ padding: 'clamp(36px, 6vw, 80px) 0', background: 'var(--bg-base)', borderTop: '1px solid var(--border-subtle)' }}>
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '700px', margin: '0 auto clamp(20px, 4vw, 44px)' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', color: 'var(--text-main)', fontWeight: 900, marginBottom: '12px', letterSpacing: '-0.02em' }}>
            {t('products.title')}
          </h2>
          ...
          {AUTO_PRODUCTS.map(p => (
            ...
            >
              ...
              <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: 'var(--amber-gold)', marginBottom: '8px' }}>
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={13} fill="var(--amber-gold)" color="var(--amber-gold)" />
                  ))}
                  <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginInlineStart: '4px' }}>(4.9/5)</span>
                </div>

                <h3 style={{ fontSize: '1.15rem', color: 'var(--text-main)', fontWeight: 800, marginBottom: '8px' }}>
                  {p.title}
                </h3>

                <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', lineHeight: 1.5, marginBottom: '16px', flexGrow: 1 }}>
                  {p.description}
                </p>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <strong style={{ fontSize: '1.3rem', color: 'var(--amber-gold)', fontWeight: 900 }}>{p.price}</strong>
                  </div>
