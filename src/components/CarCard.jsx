  ...
  return (
    <div className="car-card">
      ...
      >
        ...
        <div className="car-card-vignette" />
      ...
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
        ...
        <div style={{
          ...
          <span style={{ display: 'flex', alignItems: 'center', gap: '5px', color: 'var(--text-secondary)', fontWeight: 600 }}>
        ...
        <div style={{
          ...
          <div>
            ...
            {/* Crisp, tabular legal price in slate */}
            {currency !== 'DZD' && (
              <div style={{
                fontSize: '0.74rem',
                fontWeight: 600,
        ...
        <div style={{
          ...
          {/* Pillar 1: Boîte */}
          <div style={{ textAlign: 'center', borderInlineEnd: '1px solid var(--border-subtle)', padding: '0 4px' }}>
            <div style={{ fontSize: '10px', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 600, letterSpacing: '0.04em', marginBottom: '2px' }}>
              {t('card.gearbox')}
            </div>
            <div style={{ fontSize: '11px', fontWeight: 600, color: 'var(--text-secondary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }} title={car.transmission}>
              {car.transmission}
            </div>
          </div>
          ...
          <div style={{ textAlign: 'center', borderInlineEnd: '1px solid var(--border-subtle)', padding: '0 4px' }}>
            ...
            <div style={{ fontSize: '11px', fontWeight: 600, color: 'var(--text-secondary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }} title={car.fuel}>
              {car.fuel}
            </div>
          </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              height: '44px',
              borderRadius: '8px',
              background: isCompared ? 'rgba(251, 191, 36, 0.15)' : 'var(--surface-subtle)',
              border: isCompared ? '1.5px solid var(--amber-gold)' : '1px solid var(--border-subtle)',
              color: isCompared ? 'var(--amber-gold)' : 'var(--text-secondary)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              cursor: 'pointer',
