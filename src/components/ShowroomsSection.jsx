    ...
    <section id="showrooms" style={{ padding: 'clamp(36px, 6vw, 80px) 0', background: 'var(--bg-section-alt)', borderTop: '1px solid var(--border-subtle)' }}>
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto clamp(20px, 4vw, 44px)' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', color: 'var(--text-main)', fontWeight: 900, marginBottom: '14px', letterSpacing: '-0.02em' }}>
            {t('showrooms.title')}
          </h2>
            ...
            return (
              <div key={sr.id} className="showroom-card">
                ...
                <div style={{ padding: '22px' }}>
                  ...
                  <h3 style={{ fontSize: '1.25rem', color: 'var(--text-main)', fontWeight: 800, marginBottom: '8px' }}>
                    {sr.name}
                  </h3>
                  ...
                  <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '18px' }}>
                    {t('showrooms.hours')} <strong style={{ color: 'var(--text-main)' }}>{sr.openingHours}</strong>
                  </div>
